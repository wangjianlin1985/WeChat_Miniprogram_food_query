		...
		<div class="col-md-12 wow fadeInUp" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	<li role="presentation" ><a href="<%=basePath %>DishClass/frontlist">菜谱类别列表</a></li>
			    	<li role="presentation" class="active"><a href="#dishClassAdd" aria-controls="dishClassAdd" role="tab" data-toggle="tab">添加菜谱类别</a></li>
				</ul>
				<!-- Tab panes -->
				<div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="dishClassAdd"> 
						  ...
						  <div class="form-group">
						  	 <label for="dishClass_className" class="col-md-2 text-right">类别名称:</label>
						  	 <div class="col-md-8">
							    <input type="text" id="dishClass_className" name="dishClass.className" class="form-control" placeholder="请输入类别名称">
							 </div>
						  </div>
						  <div class="form-group">
						  	 <label for="dishClass_classDesc" class="col-md-2 text-right">类别描述:</label>
						  	 <div class="col-md-8">
							    <textarea id="dishClass_classDesc" name="dishClass.classDesc" rows="8" class="form-control" placeholder="请输入类别描述"></textarea>
							 </div>
						  </div>
				          <div class="form-group">
