...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">菜谱查询网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>DishClass/frontlist">菜谱类别</a></li>
                <li><a href="<%=basePath %>Dish/frontlist">菜谱查询</a></li>
                <li><a href="<%=basePath %>DishCollect/frontlist">收藏记录</a></li>
                <li><a href="<%=basePath %>Leaveword/frontlist">留言查询</a></li>
