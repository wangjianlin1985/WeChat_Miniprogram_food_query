...
public class NoticeService {
    ...
    /*按照查询条件分页查询新闻公告记录*/
    public ArrayList<Notice> queryNotice(String publishDate,String title,int currentPage) throws Exception { 
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<Notice> queryNotice(String publishDate,String title) throws Exception  { 
     	String where = "where 1=1";
    	if(!publishDate.equals("")) where = where + " and t_notice.publishDate like '%" + publishDate + "%'";
    	if(!title.equals("")) where = where + " and t_notice.title like '%" + title + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(String publishDate,String title) throws Exception {
     	String where = "where 1=1";
    	if(!publishDate.equals("")) where = where + " and t_notice.publishDate like '%" + publishDate + "%'";
    	if(!title.equals("")) where = where + " and t_notice.title like '%" + title + "%'";
